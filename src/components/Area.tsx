...
export default function Area(){
    ...
    return (
        ...
        <div className="flex flex-col md:flex-row gap-8 justify-center my-auto">
            <h1 className="text-3xl sm:text-4xl m-auto text-center text-[#f2f2f2] max-w-lg ">Servicing the 401 corridor, Cambridge, Kitchener, Waterloo, Milton, Missisauga, and Brampton Areas</h1>
